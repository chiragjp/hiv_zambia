...
*local filesDirectory = "/Users/ebd/Documents/MexicoCity/DHS Data"
...
*local filesDirectory = "/Users/ebd/Desktop/desktop junk/trial"
file open myfile using "`project_directory'/completeness mr_hiv files.txt", write replace
file write myfile  "variable" _tab "filename" _tab "var label" _tab "observations" _tab "completeness" _n
...
file close myfile
local project_directory="~/Dropbox/HIV xwas work/data"
insheet using "`project_directory'/completeness mr_hiv files.txt", clear
...
bys variable: egen max_n=max(n_svys)
gsort -comple varlabel
save "`project_directory'/completeness mr_hiv files", replace
