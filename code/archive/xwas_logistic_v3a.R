...
dat$v477[dat$v477 == 'none'] <- '0'
dat$v477 <- as.numeric(dat$v477)

dat$v167 <- as.character(dat$v167)
dat$v167[dat$v167 == '90+'] <- '90'
dat$v167[dat$v167 == 'none'] <- '0'
dat$v167 <- as.numeric(dat$v167)

dat$v152 <- as.character(dat$v152)
dat$v152 <- as.numeric(dat$v152)

dat$v477inj<-NA
dat$v477inj[dat$v477==0]<-0
dat$v477inj[is.na(dat$v477)]<-0
dat$v477inj[dat$v477>0 & dat$v477<6]<-1
dat$v477inj[dat$v477>5]<-2
dat$v477inj <- as.factor(dat$v477inj)
