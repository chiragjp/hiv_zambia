...
drop if cname==""
drop _merge
* variables from 2013 survey are in 2007 survey but with different name
* s1000e was removed
* after running this, I had lookfor alcohol and lookfor tb
quietly {
#delimit ;
...
/*
save "`project_directory'/hiv xwas toy dataset v6c.dta", replace
export delimited using "`project_directory'/hiv xwas toy dataset v6c.csv", replace

preserve
keep if v025==0 //urban
save "`project_directory'/hiv xwas toy dataset v6c_urban.dta", replace
export delimited using "`project_directory'/hiv xwas toy dataset v6c_urban.csv", replace
restore

preserve
keep if v025==1 //rural
save "`project_directory'/hiv xwas toy dataset v6c_rural.dta", replace
export delimited using "`project_directory'/hiv xwas toy dataset v6c_rural.csv", replace
restore

preserve
keep if v781==0 //never tested for HIV
save "`project_directory'/hiv xwas toy dataset v6c_nevertested.dta", replace
export delimited using "`project_directory'/hiv xwas toy dataset v6c_nevertested.csv", replace
restore

preserve
keep if v781==1 //tested for HIV previously
save "`project_directory'/hiv xwas toy dataset v6c_tested.dta", replace
export delimited using "`project_directory'/hiv xwas toy dataset v6c_tested.csv", replace
restore

preserve
keep if v190==1 //poorest (wealth1)
save "`project_directory'/hiv xwas toy dataset v6c_wealth1.dta", replace
export delimited using "`project_directory'/hiv xwas toy dataset v6c_wealth1.csv", replace
restore

preserve
keep if v190==2 //less poor (wealth2)
save "`project_directory'/hiv xwas toy dataset v6c_wealth2.dta", replace
export delimited using "`project_directory'/hiv xwas toy dataset v6c_wealth2.csv", replace
restore

preserve
keep if v190==3 //middle (wealth3)
save "`project_directory'/hiv xwas toy dataset v6c_wealth3.dta", replace
export delimited using "`project_directory'/hiv xwas toy dataset v6c_wealth3.csv", replace
restore

preserve
keep if v190==4 //less wealthy (wealth4)
save "`project_directory'/hiv xwas toy dataset v6c_wealth4.dta", replace
export delimited using "`project_directory'/hiv xwas toy dataset v6c_wealth4.csv", replace
restore

preserve
keep if v190==5 //wealthiest (wealth5)
save "`project_directory'/hiv xwas toy dataset v6c_wealth5.dta", replace
export delimited using "`project_directory'/hiv xwas toy dataset v6c_wealth5.csv", replace
restore
...
save "`project_directory'/hiv xwas toy dataset v6c_age1.dta", replace
export delimited using "`project_directory'/hiv xwas toy dataset v6c_age1.csv", replace
restore

preserve
keep if age_cat==2 //middle 25-34
save "`project_directory'/hiv xwas toy dataset v6c_age2.dta", replace
export delimited using "`project_directory'/hiv xwas toy dataset v6c_age2.csv", replace
restore

preserve
keep if age_cat==3 //oldest 35-50
save "`project_directory'/hiv xwas toy dataset v6c_age3.dta", replace
export delimited using "`project_directory'/hiv xwas toy dataset v6c_age3.csv", replace
